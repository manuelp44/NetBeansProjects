          ...
          <div class="mr-auto">
            <nav class="site-navigation position-relative text-right" role="navigation">
              <ul class="site-menu main-menu js-clone-nav mr-auto d-none pl-0 d-lg-block">
                ...
                <li>
                  <a href="categories.jsp" class="nav-link text-left">Categories</a>
                </li>
                <li>
                  <a href="categories.jsp" class="nav-link text-left">Politics</a>
                </li>
                <li>
                  <a href="categories.jsp" class="nav-link text-left">Business</a>
                </li>
                <li>
                    <a href="categories.jsp" class="nav-link text-left">Health</a>
                </li>
                <li><a href="categories.jsp" class="nav-link text-left">Design</a></li>
                <li>
                    <a href="categories.jsp" class="nav-link text-left">Sport</a>
                </li>
                <li>
                    <a href="contact.jsp" class="nav-link text-left">Contact</a>
                </li>
                <li><a href="eg-table-edit/index" class="nav-link text-left">Customer Registration Form</a></li>
                <li><a href="home.jsp" class="nav-link text-left">Login</a></li>
              </ul>                                                                                                                                                                                                                                                                                         
            </nav>
